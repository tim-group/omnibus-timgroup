# XXX copied from omnibus-software. ruby 2.1.6 is broken and cannot fetch from ftp via proxy
# XXX this file can be removed once ruby fixes the issue
#
...
source url: "http://www.mirrorservice.org/sites/sourceware.org/pub/libffi/libffi-#{version}.tar.gz"
